...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="bg-white rounded-2xl shadow-lg border border-gray-100 p-8">
        <div class="mb-8">
            <h2 class="text-2xl font-bold text-gray-900 font-['Outfit']">Host a New Room</h2>
            <p class="mt-2 text-gray-500">Fill in the details to list your room on RoomGo.</p>
        </div>

        <form method="POST" action="{{ route('rooms.stores') }}" enctype="multipart/form-data" class="space-y-6">
            @csrf
